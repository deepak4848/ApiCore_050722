<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Category.aspx.cs" Inherits="UI_Category" %>
...
<head runat="server">
    ...
    <link href="../Data/Home/components.css" rel="stylesheet" />
    <link href="../Data/Home/responsee.css" rel="stylesheet" />
    <link href="http://fonts.googleapis.com/css?family=Roboto:400,100,300,700&amp;subset=latin,latin-ext" rel="stylesheet" type="text/css"/>
    <link href="../Data/Home/template-style.css" rel="stylesheet" />
      ...
      <section id="home-section" class="line">
         <div class="margin">
            ...
            <div class="s-12 l-9">
               ...
               <article class="post-1 line">
                  ...
                  <div class="s-12 l-6 post-image">                   
                     <a href="post-1.html">
                     <img src="/Data/img/post1.jpg" alt="Fashion 1"/>
                     </a>                
                  </div>
                  <!-- text -->                 
               ...
               <article class="post-2 right-align line">
                  ...
                  <div class="s-12 l-6 post-image">                   
                     <a href="post-2.html">
                     <img src="/Data/img/post2.jpg" alt="Fashion 2"/>
                     </a>                
                  </div>
                  <!-- text -->                 
                  <div class="s-12 l-5 post-text">
               ...
               <article class="post-3 line">
                  ...
                  <div class="s-12 l-6 post-image">                   
                     <a href="post-3.html">
                     <img src="/Data/img/post3.jpg" alt="Fashion 3"/>
                     </a>                
                  </div>
                  <!-- text -->                 
                  <div class="s-12 l-5 post-text">
               ...
               <article class="post-4 right-align line">
                  ...
                  <div class="s-12 l-6 post-image">                   
                     <a href="post-4.html">
                     <img src="/Data/img/post4.jpg" alt="Fashion 4">
                     </a>                
                  </div>
                  <!-- text -->                 
                  <div class="s-12 l-5 post-text">
            ...
            <div class="s-12 l-3">
               <aside>
                  <!-- NEWS 1 -->           
                  <img src="/Data/img/news1.jpg" alt="News 1"/>          
                  <div class="aside-block margin-bottom">
                     <h3>This is the first news on blog</h3>
                     <p>Lorem ipsum dolor sit amet, conse ctetuer. Duis autem vemeu iriure dolor adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam</p>
                  </div>
                  <!-- NEWS 2 -->           
                  <img src="/Data/img/news2.jpg" alt="News 2"/>          
                  <div class="aside-block margin-bottom">
                  ...
                  <div class="advertising margin-bottom">
                     <img src="/Data/img/banner.jpg" alt="ad banner"/>         
                  </div>
               </aside>
            </div>
         </div>
    ...
    <script src="../Data/Home/jquery-1.8.3.min.js"></script>
    <script src="../Data/Home/jquery-ui.min.js"></script>
    <script src="../Data/Home/modernizr.js"></script>
    <script src="../Data/Home/responsee.js"></script>
    </body>
</html>
